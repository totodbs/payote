  ...
  customElements.define('pickup-availability', class PickupAvailability extends HTMLElement {
    ...
    fetchAvailability(variantId) {
      ...
      fetch(variantSectionUrl)
        ...
        .catch(e => {
          const button = this.querySelector('pickup-button');
    ...
    renderError() {
      ...
      this.querySelector('pickup-button').addEventListener('click', this.onClickRefreshList);
    }
...
if (!customElements.get('pickup-availability-drawer')) {
  customElements.define('pickup-availability-drawer', class PickupAvailabilityDrawer extends HTMLElement {
    constructor() {
      ...
      this.querySelector('pickup-button').addEventListener('click', () => {
        this.hide();
      });
